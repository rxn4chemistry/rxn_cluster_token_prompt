...
@click.command()
@click.option('--input_csv_file', '-i', type=click.Path(exists=True), required=True,
...
@click.option('--output_path', '-o', type=click.Path(exists=True), required=True,
              help="Output path")
@click.option('--model-type', '-m', type=str, default="retro",
...
@click.option('--cluster-column-name', type=str, default="cluster_id",
